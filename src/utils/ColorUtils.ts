import { AllColors } from "../models/Types";

export const getBorderStyle = (color: AllColors) => {
...
export const getTextStyle = (color: AllColors) => {
...
export const getBackgroundStyle = (color: AllColors) => {
